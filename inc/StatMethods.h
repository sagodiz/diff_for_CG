...
commonCounters makeStat(const std::set<std::pair<int, int>>& compareSet1, const std::set<std::pair<int, int>>& compareSet2, Named * l1, Named * l2, const std::vector<Record>& r1, const std::vector<Record>& r2);
void makeGraphDBStat(const std::vector<std::string>& labels);
void writeTSV(const std::vector<Record>&, std::string, std::string);
...
*/
void writeConnTSV( const std::set<std::pair<int, int>>&, std::string);
